    ...
    >
      ...
      <div class="p-3 border-t border-zinc-800/80 space-y-2 bg-zinc-950/60">
        ...
        <a
          ...
          class="w-full flex items-center justify-between px-3 py-2 rounded-lg bg-zinc-900/80 border border-zinc-800 hover:border-cyan-500/50 hover:bg-zinc-900 text-zinc-300 hover:text-cyan-300 transition-all text-xs font-medium group"
        >
          <div class="flex items-center gap-2">
            ...
            <span class="font-mono text-[11px]">TalosDeck GitHub</span>
          </div>
