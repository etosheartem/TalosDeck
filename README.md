...
- Health Score: объяснимые вычеты, покрытие проверок и отдельные состояния
  отсутствующих/устаревших данных; общий снимок с диагностикой.
...
- Шаблоны кластеров с неизменяемыми ревизиями и созданием через проверяемый план.
